export const TEMPLATE_HTML = (message: string, accepted: boolean) => {
  let messageBox = "";
  message
    .split(/\r?\n/)
 ...
 <div>
  ...
  ${
    accepted
      ? `<div>Help us grow by rating our games</div>
 <div> <a href='https://play.google.com/store/apps/dev?id=9205738346587560692' target='_blank'><img src='https://i.postimg.cc/tT22JDHC/play-stars-reviews-1.png' border='0' alt='play-stars-reviews-1'/></a></div>
